...
const Bouton = (props) => {
    ...
    let btnCss = `btn ${props.typeBtn} ${props.css}`//${props.typeBtn} = on va récupérer le type de bouton qui sera passé en paramètre de notre composant Bouton avec le switch ds animal.js
