...
const Bouton = (props) => {
    ...
    let btnCss = `btn ${props.typeBtn} ${props.css}`//${props.typeBtn} = on va récupérer le type de bouton ds les props de notre composant Bouton avec le switch et des classes b ds animal.js
