...
const Bouton = (props) => {
    ...
    return <button className={btnCss} onClick={props.onClick}>{props.children}</button> //onClick = gestion événements en faisant passer les informations à travers les props// Envois d'un text toujours via les props ds la partie children
};
