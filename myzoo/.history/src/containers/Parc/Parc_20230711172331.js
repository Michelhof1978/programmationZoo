...
class  Parc extends Component{//Récupération des données et instalation du module AXIOS npm install axios --save
        ...
        handleSelectionFamille = (idFamille) => {CLIQUE//Fonction qui devra se lancer lors du clic sur bouton et devra transferer cette fonction au niveau du composant Animal (spread operator ...Animal) et qui devra récupérer l'id de la famille
