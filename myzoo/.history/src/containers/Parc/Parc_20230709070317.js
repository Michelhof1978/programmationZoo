            ...
            <div className='container'>
                {
                    ...
                    this.state.animaux.map(animal =>{//Si c'est vrai, on va parcourir le tableau grâce à map et on va récuperre chacune des lignes du tableau animal
                        return <Animal {...animal} key={animal.id}/>//On va afficher tous les infos de l animal avec le pread operator(on enverra toutes les propriété), si ce n était qu'une seule info à afficher, on aurait fait: animal.id, animal.nom...
