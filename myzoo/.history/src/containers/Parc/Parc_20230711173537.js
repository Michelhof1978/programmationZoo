...
class  Parc extends Component{//Récupération des données et instalation du module AXIOS npm install axios --save
        ...
        handleSelectionContinent = (idContinent) => {//Fonction qui devra SE LANCER SUR LE COMPOSANT ANIMAL lors du clic sur bouton et devra t n(spread operator ...Animal) et qui devra récupérer l'id du continent ET AINSI L AFFICHER DS LA CONSOLE
