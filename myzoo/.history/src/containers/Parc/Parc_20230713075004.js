...
class  Parc extends Component{
        ...
        loadData = () => {
            const famille = this.state.filtreFamille ? this.state.filtreFamille : "-1";//Si filtreFamille est vrai, on va récupérer la valeur de filtreFamille sinon on va récupérer la valeur all
