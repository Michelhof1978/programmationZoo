                    ...
                    props.continents.map(continent => {//map = parcourir un tableau et récupérer tous les continents et les retourner un à un
                        ...
                        return (
                            <Bouton 
                                ...
                                onClick={() => props.filtreContinent(continent.idContinent)}//On lance la fonction lors DU clic et va parcourir les continents concernés, c'est celui qu on est en train de parcour avec map ci-dessus
