            ...
            <div className="card-body">
                <h3>Continents : </h3>
                {
                    props.continents.map(continent => {//map = parcourir un tableau et récupérer tous les continents et les retourner un à un
                        ...
                        //On récupére ci-dessus tous les continents et on les return sous forme de bouton, ainsi tous les continents qui ont été crée sur le serveur seront affichés sous forme de bour
