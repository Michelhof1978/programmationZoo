         ...
         {/* Description de l animal */}
            ...
            <div className="text-center" style={{"height": "100px"}} >
             ...
             <div className="card-body">
                ...
                <h3>Famille : <Bouton typeBtn="btn-dark" click = {props.filtreFamille(props.famille.idFamille)}>{props.famille.libelleFamille.toUpperCase()}</Bouton></h3>
                ...
                <h3>Continents : </h3>
                {
                    props.continents.map(continent => {//map = parcourir un tableau et récupérer tous les continents et les retourner un à un
                        ...
                        return <Bouton 
                            typeBtn={colorBtn} 
                            css="m-1" 
                            click = {props.filtreContinent(continent.idContinent)}//On lance la fonction lors du clic pour parcourir les continents
