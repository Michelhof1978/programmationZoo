         ...
         {/* Description de l animal */}
            ...
            <div className="card-body">
                <h3>Continents : </h3>
                {
                    ...
                    })//Pour la propriété Css, ça ne sera pas className car c'est une propriété spécifique à React, on va donc mettre css car nous avons défini la propriété cssn ds 
                }
            </div> 
        </div>
    </>
