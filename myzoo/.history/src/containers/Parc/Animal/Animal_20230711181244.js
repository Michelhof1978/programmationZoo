    ...
    <>
        ...
        {/* Affichage de l'Id et du nom de l'animal en h3 */}
         ...
         {/* Description de l'animal */}
            ...
            {/* CLIQUE SUR BOUTON FILTRE URL props.filtreFamille(props.famille.idFamille)} uniqueme*/}
                <Bouton typeBtn="btn-dark" onClick={() =>
                 props.filtreFamille(props.famille.idFamille)}>{props.famille.libelleFamille.toUpperCase()}
                </Bouton>
