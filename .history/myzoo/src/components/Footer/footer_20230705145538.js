...
Il est important de noter que la classe `d-block` est spécifique à Bootstrap, et elle peut varier légèrement selon la version de
 Bootstrap que vous utilisez. Assurez-vous d'inclure la feuille de style Bootstrap appropriée dans votre projet pour que la classe fonctionne correctement.
-----------------------------------------------------------------------------------------------------------------------
