...
"nav-link", "p-0", et "m-0" sont des classes CSS prédéfinies, tandis que classes.p_footerLink est une classe définie localement dans le composant (probablement avec une bibliothèque de styles telle que CSS Modules). Les noms de classe sont inclus dans un tableau pour pouvoir les concaténer ultérieurement.
