...
const titreH1 = (props) => { 
    ...
    let monCSS = `border border-dark my-1 p-2 text-white text-center rounded ${backgroundColor}`;// UTILISER LES BACKTICKS `````` Attention

    return <h1 className={monC}>{props.children}</h1>
