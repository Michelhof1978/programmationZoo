...
import { BrowserRouter as Router, Routes, Route } from 'react-router-dom';//Import composant Switch qui va permettre d indiquer que l on va pouvoir accéder à une route en pârticulier et du composant route qui va définir quel sera le canal, la route disponible pour une Url données. 
import Accueil from './Accueil/Accueil';

class  Site extends Component{//Composant STATEFUL qui va être gérer par App.js
    render() {
        return (
            <Router> {/* Utilisez le composant Router pour englober toute l'application */}
            <>
              <Navbar />
