...
import {Switch, Route} from "react-router-dom";//Import composant Switch qui va permettre d indiquer que l on va pouvoir accéder à une route en pârticulier et du composant route qui va définir le canal
