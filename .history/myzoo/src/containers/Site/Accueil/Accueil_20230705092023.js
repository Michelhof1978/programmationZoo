...
`componentDidMount` est une méthode du cycle de vie d'un composant React qui est appelée une fois que le composant a été monté dans le DOM (Document Object Model). C'est l'un des nombreux hooks de cycle de vie disponibles dans React.
