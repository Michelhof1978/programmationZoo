...
2. Manipulation du DOM : Si vous avez besoin d'effectuer des manipulations directes sur le DOM après que le composant ait été
 rendu, `componentDidMount` est le bon endroit pour le faire. Par exemple, vous pouvez utiliser cette méthode pour initialiser des bibliothèques tierces qui nécessitent une référence à des éléments DOM spécifiques.
