...
configuration ou les préférences de l'utilisateur, `componentDidMount` peut être utilisé pour déclencher le chargement initial et mettre à jour l'état du composant en conséquence.
