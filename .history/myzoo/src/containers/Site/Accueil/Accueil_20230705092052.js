...
Si vous avez besoin de mettre à jour le composant en réponse à des changements de props ou d'état, vous devriez envisager d'utiliser d'autres méthodes du cycle de vie, telles que `componentDidUpdate`.
