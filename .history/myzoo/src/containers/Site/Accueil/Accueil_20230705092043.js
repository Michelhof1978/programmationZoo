...
3. Abonnements aux événements : Si vous devez mettre en place des abonnements à des événements, comme des écouteurs d'événements
 de fenêtre ou de document, `componentDidMount` est un bon endroit pour les initialiser. Cela garantit que les abonnements sont actifs une fois que le composant est monté et prêt à recevoir des événements.
