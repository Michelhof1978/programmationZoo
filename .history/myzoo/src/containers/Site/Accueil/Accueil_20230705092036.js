...
données nécessaires au fonctionnement de votre composant ou de votre application. Par exemple, vous pouvez récupérer des données d'un serveur backend et les mettre à jour dans l'état du composant.
