...
-Pour rendre le contenu dynamiquement, on va utiliser  {props.children} qui va afficher "La page n existe pas" qui sera l enfant et affiché aprés du parent H1
--------------------------------------------------------------
--------------------------------------------------------------
--------------------------------------------------------------
--------------------------------------------------------------
